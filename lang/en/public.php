...
return [
    ...
    "enter_state_and_city" => "Enter State and City",
    ...
    "max" => "Max",
    "withdrawal_fee" => "Withdraw Fee",
    "receive_amount" => "Receive Amount",
    "filter_by_type" => "Filter By Type",
    "filter_by_status" => "Filter By Status",
    "lot_size_rebate" => "Rebate Bonus",
    "extra_bonus" => "Extra Bonus",
    "withdrawal_amount_required" => "Withdraw Amount is required.",
    ...
    "setup_pin" => "Setup PIN",
    "setup_pin_caption" => "Setup PIN to secure your account. Your PIN is used to confirm your payment.",
    "pin_code" => "PIN Code",
    "confirm_your_pin" => "Confirm Your PIN Code",
    "save" => "Save",
    "no_security_pin" => "No Security PIN",
    "no_security_pin_caption" => "Setup your PIN to proceed.",
    "no_payment_accounts" => "No Payment Accounts",
    "no_payment_accounts_caption" => "Add your payment account to proceed.",
    "toast_update_pin_success" => "Successfully updated Security PIN.",
    "security_pin_incorrect" => "Your security PIN is incorrect. Please re-enter it carefully.",
    "current_pin_code" => "Current PIN Code",
    "current_pin_invalid" => "Your current PIN is invalid. Please re-enter it carefully.",
    "reset_pin" => "Reset PIN",
    "otp_will_send_to" => "OTP will be sent to :email",
    "request_otp" => "Request OTP",
    "otp_code" => "OTP Code",
    "otp_sent" => "OTP Sent",
    "resend_in" => "Resend in :seconds seconds",
    "resend_otp" => "Resend OTP",
    "reset_pin_otp" => "Reset PIN - OTP",
    "apply_otp" => "Apply OTP Code to reset PIN",
    "toast_reset_pin_success" => "Successfully reset PIN.",
];
