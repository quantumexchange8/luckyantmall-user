...
const fetchData = async () => {
    try {
        ...
        const ctx = document.getElementById('totalRebateChart');

        isLoading.value = true;

        const response = await axios.get('/portal/dashboard/get_total_rebate_by_years', { params: { year: year.value } })
...
<template>
    <div class="relative w-full h-[350px] flex items-center justify-center">
        ...
        <canvas id="totalRebateChart" height="350" v-show="!isLoading"></canvas>
    </div>
</template>
